...
nativefier 'https://www.inoreader.com/' Inoreader.app -n Inoreader --counter --conceal -p mac --min-width 1200 --min-height 800 --darwin-dark-mode-support -i inoreader.png --title-bar-style hiddenInset --inject inoreader.css
